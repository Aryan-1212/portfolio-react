...
export default function Home() {
    return (
        <div className="mx-auto w-full max-w-7xl">
            <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16 flex items-center justify-center lg:block">
                ...
                <div className="absolute inset-0 w-full sm:my-10 sm:pt-1 pt-12 h-full flex items-start justify-center lg:block">
                    <img className="w-96 mix-blend-color-burn" src="src\assets\index-logo2.jpg" alt="image1" />
                </div>
            </aside>

            <div className="grid place-items-center px-10 sm:px-0">
                <img className="w-96 mix-blend-color-burn" src="src\assets\index-logo1.png" alt="image2" />
            </div>

            <h1 className="text-center text-2xl sm:text-5xl -mt-10 py-10 font-medium">It's a portfolio website.</h1>
            ...
            <div className='flex flex-col justify-center items-center my-5 sm:my-10 lg:my-20 space-y-5 sm:mx-20 lg:flex-row lg:space-x-5 lg:mx-2'>
                ...
                <div className='flex flex-col justify-center items-center space-y-5 text-center px-5 sm:px-0'>
                    ...
                    <Link to="projectlayout" className='text-2xl relative font-medium sm:text-5xl text-orange-700 link-underline'>ScanToDine College Project</Link>
