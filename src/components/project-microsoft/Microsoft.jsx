      ...
      <div className='px-5 sm:px-10 md:px-16 lg:px-20 xl:px-20 space-y-20'>
        <div className='flex flex-col p-2 sm:p-10 rounded-lg custom-shadow space-y-5 dark:bg-gray-600'>
          <div className='flex space-y-4 flex-col py-5 items-center'>
            <div><p className='text-3xl text-center sm:text-4xl md:text-5xl xl:text-7xl text-orange-700 dark:text-[#ffb703] font-bold'>Microsoft Clone</p></div>
          </div>
          <div>
            <img className='rounded-lg shadow-2xl' src="../src\assets\microsoft.png" alt="" />
          </div>
          <div className='space-y-2'>
            <p className='text-lg md:text-2xl dark:text-white'>Technologies - HTML, CSS(Tailwind)</p>
            <p className='text-sm md:text-lg text-gray-700 dark:text-gray-50'>A responsive clone of Microsoft's website using TailwindCSS to deepen my understanding of responsive design principles and modern CSS frameworks. This project served as a comprehensive learning experience, allowing me to explore the intricacies of creating adaptive user interfaces that work seamlessly across various devices and screen sizes.
          ...
          <div className='flex text-lg sm:text-2xl justify-center sm:px-32 text-orange-700 dark:text-[#ffb703]'>
            <div><Link to="https://github.com/Aryan-1212/microsoft-clone.git" target='_blank' className='relative link-underline dark:link-underline-dark'>Github</Link></div>
          </div>
