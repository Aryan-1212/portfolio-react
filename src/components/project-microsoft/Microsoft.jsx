          ...
          <div className='space-y-5'>
            ...
            <div className='space-y-10'>
              ...
              <div className='flex justify-around'>
                <div>
                  <img className='rounded-lg h-[70vh] custom-shadow' src="../src\assets\microsoft-5.png" alt="" />
                </div>
                <div>
                  <img className='rounded-lg h-[70vh] custom-shadow' src="../src\assets\microsoft-4.png" alt="" />
                </div>
              </div>
            </div>
          </div>
