      ...
      <div className='px-5 sm:px-10 md:px-16 lg:px-20 xl:px-20 space-y-20'>
        <div className='flex flex-col p-2 sm:p-10 rounded-lg custom-shadow space-y-5'>
          <div className='flex space-y-4 flex-col py-5 items-center'>
            <div><p className='text-3xl sm:text-4xl md:text-5xl xl:text-7xl text-orange-700 font-bold'>Flipkart Clone</p></div>
          </div>
          <div>
            <img className='rounded-lg shadow-2xl' src="../src\assets\flipkart.png" alt="" />
          </div>
          <div className='space-y-2'>
            <p className='text-lg md:text-2xl'>Technologies - HTML, CSS, JavaScript</p>
            <p className='text-sm md:text-lg text-gray-700'>I developed a Flipkart clone using HTML and CSS, showcasing my expertise in front-end development and my ability to recreate intricate e-commerce layouts. This project provided an opportunity to dive into the complexities of designing a functional and visually appealing online store, with a focus on replicating the detailed structure and features of the Flipkart website.
            </p>
