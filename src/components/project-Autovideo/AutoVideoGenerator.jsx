      ...
      <div className='px-5 sm:px-10 md:px-16 lg:px-20 xl:px-20 space-y-20'>
        <div className='flex flex-col p-2 sm:p-10 rounded-lg custom-shadow space-y-5'>
          <div className='flex space-y-4 flex-col py-5 items-center'>
            <div><p className='text-3xl text-center sm:text-4xl md:text-5xl xl:text-7xl text-orange-700 font-bold'>Auto-Video Generator</p></div>
          </div>
          <div>
          ...
          <div className='space-y-5'>
            <p className='text-lg md:text-2xl'>Video Script</p>
            <div>
              <img className='rounded-lg custom-shadow' src="../src\assets\videoGen-2.png" alt="" />
            </div>
            <div className='w-full h-0.5 bg-orange-700'></div>
            <p className='text-lg md:text-2xl'>Generated Video</p>
            <div>
