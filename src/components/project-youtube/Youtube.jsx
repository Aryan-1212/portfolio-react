      ...
      <div className='px-20 space-y-20'>
        <div className='flex flex-col p-10 rounded-lg custom-shadow space-y-5'>
          ...
          <div className='space-y-5'>
            ...
            <div className='space-y-10'>
              ...
              <div className='flex justify-around'>
                <div>
                  <img className='rounded-lg h-[70vh] custom-shadow' src="../src\assets\youtube-2.png" alt="" />
                </div>
                <div>
                  <img className='rounded-lg h-[70vh] custom-shadow' src="../src\assets\youtube-3.png" alt="" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='flex text-2xl justify-center px-32 text-orange-700'>
            <div><Link to="https://github.com/Aryan-1212/youtube-clone.git" target='_blank' className='relative link-underline'>Github</Link></div>
          </div>
