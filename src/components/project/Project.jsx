  ...
  return (
    <div className="mx-auto w-full max-w-7xl my-20">
      <div className='px-5 sm:px-10 md:px-16 lg:px-24 xl:px-40 space-y-20'>
        ...
        <ProjectCard src="src\assets\jarvis.jpg" to="jarvisai" title="Jarvis AI" tech="Python" desc="A voice-activated assistant capable of performing various tasks based on voice commands. This project leverages multiple APIs and libraries, including openai-api, weather-api, news-api, and the Speech Recognition library." />
