    ...
    <div className="mx-auto w-full max-w-7xl my-20">
      <div className='px-5 sm:px-10 md:px-16 lg:px-20 xl:px-20 space-y-20'>
        <div className='flex flex-col p-2 sm:p-10 rounded-lg custom-shadow space-y-5'>
          ...
          <div className='space-y-2'>
            <p className='text-sm md:text-2xl'>Watch Demo Video Here</p>
            <div className='text-lg md:text-2xl text-orange-700'><Link to="https://youtu.be/MBAcF-OAueA?si=FQ4u8fVkMuNZkFvM" target='_blank' className='relative link-underline'>Demo Video</Link></div>
          </div>
          <div className='w-full h-0.5 bg-orange-700'></div>
          <div className='flex text-sm flex-col items-center space-y-2 sm:flex-row sm:text-lg sm:px-10 xl:text-2xl justify-between xl:px-32 text-orange-700'>
